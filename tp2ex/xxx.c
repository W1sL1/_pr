...
int main(void) {
    ...
    /* --- NEW: максимальная длина значения среди всех непустых узлов --- */
    {
        int max_vlen = 1;
        size_t i;
        for (i = 0; i < p.size; i++) {
        ...
        /* --- NEW: ширина полотна считается от числа листьев последнего
                  уровня и длины значения, а не от 2^(h+1) --- */
        {
