...
// 
// давай теперь такой тест который на все 
// 
// (sqrt(a^2 + b^2) + sin(x)^2 + cos(x)^2 + tg(y)*ctg(y) + arcsin(sin(0.1)) + arccos(0)*2 + (z+1)! - 5^2^1) / 2 - 6 - 3.0 4.0 0.5 0.8 0.1 2.0 - 5.050000
